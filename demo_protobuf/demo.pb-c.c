...
{
  PROTOBUF_C_ASSERT (message->base.descriptor == &demo__demo__descriptor);
...
{
  {
    ...
    0,   /* quantifier_offset */
    PROTOBUF_C_OFFSETOF(Demo__DEMO, username),
    NULL,
    NULL,
    0,            /* packed */
  ...
  },
  {
    ...
    PROTOBUF_C_TYPE_STRING,
    0,   /* quantifier_offset */
    PROTOBUF_C_OFFSETOF(Demo__DEMO, password),
    NULL,
    NULL,
    0,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    0,   /* quantifier_offset */
    PROTOBUF_C_OFFSETOF(Demo__DEMO, timestamp),
    NULL,
    NULL,
    0,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_OFFSETOF(Demo__DEMO, has_role),
    PROTOBUF_C_OFFSETOF(Demo__DEMO, role),
    NULL,
    NULL,
    0,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
